...
export interface ApprovalRpcClient {rpc(name:string,args:Record<string,unknown>):Promise<{data:any;error:{message?:string}|null}>;}
export function createApprovalRpcServiceWithClient(client:ApprovalRpcClient):ApprovalCommandService{
...
export function createApprovalRpcService():ApprovalCommandService|null{
 ...
 return createApprovalRpcServiceWithClient(client as unknown as ApprovalRpcClient);
}
