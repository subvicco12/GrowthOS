...
begin
  ...
  values(p_actor_id,r.site_id,'recommendation.decision','recommendation',p_recommendation_id,coalesce(p_note,p_decision),jsonb_build_object('status',previous_status),jsonb_build_object('status',p_decision));
  return r;
end $$;
